...
public class EntityUtils {
	...
	static boolean canStand(org.bukkit.block.Block base){
		...
		if(!below.isEmpty() && net.minecraft.server.v1_6_R2.Block.byId[below.getTypeId()].material.isSolid()){
			if(base.isEmpty() || net.minecraft.server.v1_6_R2.Block.byId[base.getTypeId()].material.isSolid()==false){
				return true;
			}
		}
		return false;
